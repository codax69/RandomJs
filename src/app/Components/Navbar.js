    ...
    <>
      <div className="fixed flex w-screen justify-between items-center bg-white hover:cursor-pointer lg:w-screen lg:justify-around py-2 z-40">
        <a onClick={() => router.push("/")}>
          <div className="flex items-center">
            <h1 className="text-slate-900 pl-3 text-xl lg:font-normal lg:text-3xl">
              Random
            </h1>
            <img
              className="h-12"
      ...
      >
        ...
        <a
          onClick={() => {
            setOpen(!open);
            setTimeout(() => router.push("/Q&A/Js"), 100);
          }}
          className="nav-link font-lg text-slate-900 font-semibold py-4 px-3 lg:hover:text-[#ffe100] hover:text-yellow-400"
        >
          Q&A
        </a>
        <a
