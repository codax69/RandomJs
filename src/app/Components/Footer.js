  ...
  return (
    ...
    <div className=" bg w-full ">
      <div className=' max-w-7xl mx-auto h-auto pt-24 text-white '>
        ...
        <NavBox Head='Question And Answer' url1="/Q&A/Js" navLink1="Javascript" url2="/Q&A/React" navLink2="React" url3="/Q&A/Next" navLink3="Next" />
        <NavBox Head='Question And Answer' url1="/Q&A/Js" navLink1="Javascript" url2="/Q&A/React" navLink2="React" url3="/Q&A/Next" navLink3="Next" />
        <NavBox Head='Question And Answer' url1="/Q&A/Js" navLink1="Javascript" url2="/Q&A/React" navLink2="React" url3="/Q&A/Next" navLink3="Next" />
        </div>
        ...
        <a onClick={() => router.push("/")}>
          <div className='flex items-center'>
            <h1 className='text-black pl-16 py-11 text-xl lg:font-normal lg:text-3xl'>Random</h1>
